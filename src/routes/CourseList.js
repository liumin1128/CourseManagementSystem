    ...
    this.columns = [{
      ...
      render: teacher => <Popover
        content={<div style={{ maxWidth: 300 }}>
          <ul>
            <li><img style={{ width: 100, height: 100 }} src={teacher.avatarUrl} alt="" /></li>
            <li>姓名：{teacher.nickName}</li>
          </ul>
        </div>} title="教师信息"
      >
        <a>{teacher.nickName}</a>
      </Popover>,
    }, {
      title: '学生列表',
      dataIndex: 'students',
      ...
      render: (i, record) => <span className={styles.operation}>
        ...
        <a onClick={this.evaluateHandler.bind(this, record)}>评分</a>
